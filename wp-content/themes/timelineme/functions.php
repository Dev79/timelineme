...
*
* Description: Time Line Me Wordpress Theme a next gen website, for non-linear story telling! Responsive & user-friendly, with voice recognition support!
*
* Version: 1.2 
*/

add_action( 'after_setup_theme', 'ab_tf_timetravel_setup' );
function ab_tf_timetravel_setup() {
	...
	/*if (!isset( $_GET['post_type'] ) ){
		add_filter('pre_get_posts','ab_tf_timetravel_sf');
	}*/
	...
	add_image_size('circle-big', 380, 380, $crop = true);
	...
	//Hide older posts
	add_filter( 'posts_where', 'ab_tf_hop_exclude_posts' );
	add_filter( 'getarchives_where', 'ab_tf_hop_exclude_posts' );
	...
	//Enqueue default theme font
	add_action( 'wp_enqueue_scripts', 'ab_tf_timetravel_opensans' );
	...
	//Custom menu header
	add_filter('wp_nav_menu_items','ab_tf_add_first_nav_item', 10, 2);

	//Adds search to menu
	add_filter('wp_nav_menu_items','ab_tf_add_search_box_to_menu', 10, 2);
...
function ab_tf_load_custom_wp_admin_js() {
		wp_register_script('admin_js', get_template_directory_uri().'/js/admin_js.js', false,'1.2',true);
...
//Register javascripts and css
function ab_tf_timetravel_scripts() {
	global $wp_styles;
	...
	wp_register_script('ab_tf_prettyPhoto', get_template_directory_uri().'/js/jquery.prettyPhoto.js', false,'1.2',true);
	wp_enqueue_style('ab_tf_prettyPhoto', get_template_directory_uri().'/css/prettyPhoto.css');
	wp_enqueue_script('ab_tf_prettyPhoto');
	wp_register_script('ab_tf_easing', get_template_directory_uri().'/js/jquery.easing.1.3.js', false,'1.2',true);
	wp_enqueue_script('ab_tf_easing');
	wp_register_script('ab_tf_flexslider', get_template_directory_uri().'/js/jquery.flexslider.js', false,'1.2',true);
	wp_enqueue_script('ab_tf_flexslider');
	wp_enqueue_style('ab_tf_flexslider', get_template_directory_uri().'/css/flexslider.css');
	wp_register_script('ab_tf_ddsmoothmenu', get_template_directory_uri().'/js/ddsmoothmenu.js', false,'1.2',true);
	wp_enqueue_script('ab_tf_ddsmoothmenu');
	wp_enqueue_style('ab_tf_customdropdowncss', get_template_directory_uri().'/functions/adminanddropdown.css');
	wp_register_script('ab_tf_modernizr', get_template_directory_uri().'/js/modernizr.custom.79639.js', false,'1.2',true);
	wp_enqueue_script('ab_tf_modernizr');
	wp_register_script('ab_tf_move', get_template_directory_uri().'/js/move.js', false,'1.2',true);
	wp_enqueue_script('ab_tf_move');
	wp_register_script('ab_tf_vegas', get_template_directory_uri().'/js/jquery.vegas.js', false,'1.2',true);
	wp_enqueue_style('ab_tf_vegas', get_template_directory_uri().'/css/jquery.vegas.css');
	wp_enqueue_script('ab_tf_vegas');	
	wp_register_script('ab_tf_classList', get_template_directory_uri().'/js/classList.js', false,'1.2',true);
	wp_enqueue_script('ab_tf_classList');
	if(is_single() || is_page()){
		wp_register_script('ab_tf_fbcomments', '//connect.facebook.net/en_EN/all.js#xfbml=1&status=0', false,'1.2',true);
		wp_enqueue_script('ab_tf_fbcomments');
	}
	wp_register_script('ab_tf_nanoscroller', get_template_directory_uri().'/js/jquery.nanoscroller.js', false,'1.2',true);
	wp_enqueue_script('ab_tf_nanoscroller');
	wp_register_script('ab_tf_customdropdown', get_template_directory_uri().'/js/jquery.dd.js', false,'1.2',true);
	wp_enqueue_script('ab_tf_customdropdown');
	wp_register_script('ab_tf_voicec', get_template_directory_uri().'/js/annyang.min.js', false,'1.2',true);
	wp_enqueue_script('ab_tf_voicec');
	wp_register_script('ab_tf_opentip', get_template_directory_uri().'/js/opentip-jquery.js', false,'1.2',true);
	...
	if(of_get_option('active-backgroud-video', 'no entry' ) == '1' ){
		wp_register_script('ab_tf_bigvideo', get_template_directory_uri().'/js/bigvideo.js', false,'1.2',true);
		wp_enqueue_script('ab_tf_bigvideo');	
		wp_register_script('ab_tf_videoto', '//vjs.zencdn.net/c/video.js');
		wp_enqueue_script('ab_tf_videoto');	
		wp_register_script('ab_tf_transit', get_template_directory_uri().'/js/jquery.transit.min.js', false,'1.2',true);
		wp_enqueue_script('ab_tf_transit');
	}
	wp_enqueue_style('ab_tf_responsive', get_template_directory_uri().'/css/responsive.css');
	if(of_get_option('active-backgroud-yt', '0' ) == '1'){
		wp_register_script('ab_tf_tubular', get_template_directory_uri().'/js/jquery.tubular.1.2.js', false,'1.2',true);
		wp_enqueue_script('ab_tf_tubular');
	}
	$theme  = wp_get_theme();
    wp_register_style( 'ab_tf_timetravel-ie9', get_stylesheet_directory_uri() . '/css/styleIE.css', false, $theme['Version'] );
    $GLOBALS['wp_styles']->add_data( 'ab_tf_timetravel-ie9', 'conditional', 'IE 9' );
    wp_enqueue_style( 'ab_tf_timetravel-ie9' );
}
// Add specific CSS class by filter
function ab_tf_timetravel_addclass($classes) {
	$classes[] = "classictilt";
	return $classes;
}
// This one shows/hides the an option when a checkbox is clicked.
...
// Search only in posts
/*function ab_tf_timetravel_sf($query) {
	if ($query->is_search) {
...
*/
//Send vars for AJAX infinite scroll  - 4vR change posts order to random here- to give it that non-linear feel
...
if (!function_exists( 'ab_tf_timetrvale_comment' ) ){
global $scramble;
$scramble = 1;
function ab_tf_timetrvale_comment( $comment, $args, $depth ) {
	$tr_comm_said = of_get_option('tr-comm-said', 'said');
	$tr_comm_waitapp = of_get_option('tr-comm-waitapp', 'Your comment is awaiting moderation.');
	$tr_comm_attime = of_get_option('tr-comm-attime','at');
	...
	global $scramble;?>
		<section class=" <?php if($scramble == 1){?>right-content<?php  }else {?>left-content<?php };?> ">
                        ...
                        <div class="gray-container <?php global $ab_tf_post_color; echo $ab_tf_post_color;?>" > 
							...
							<div class="icon-soc-container">
						   		<div class="share-btns">								
									<div class="empty-left time-holder-nob"><i class="icon-time icon-large"></i><a href"<?php echo get_comment_link( $comment->comment_ID )?>"> <?php echo get_comment_time('H:i'); ?></a>
									</div>
                                </div>   
                            </div>
                        </div>
			...
			<div class="<?php global $ab_tf_post_color; echo $ab_tf_post_color;?>">
                <div class="timedate"> 
                    <div class="tt-day"><?php echo get_comment_date('d')?></div>
                    <div class="tt-month"><?php echo get_comment_date('M'); ?></div>
                    <div class="tt-year"><?php echo get_comment_date('Y'); ?></div>
                </div>
...
function ab_tf_t_pagination($pages = '', $range = 2){
	if(of_get_option('def-pagination-display') != "infinite"){
		$showitems = ($range * 2)+1;  
		 ...
		 if(1 != $pages){
         	echo '<div class="pagination"><div class="p-position animated fadeOutH"><nav id="page_nav"></nav>';
...
//Hide older posts
function ab_tf_hop_exclude_posts( $where ) {
...
if (function_exists('register_sidebar')) {
	register_sidebar(array(
		'name' => 'Footer clock widget',
		'id' => 'archive-time',
		'description' => 'Appears on clock hover',
...
function options_typography_enqueue_google_font($font) {
	...
	$checkssl = (empty($_SERVER['HTTPS'])) ? 'http://' : "https://";
	wp_enqueue_style( "options_typography_$font", $checkssl."fonts.googleapis.com/css?family=$font", false, null, 'all' );
}
...
function ab_tf_timetravel_opensans() {
    $protocol = is_ssl() ? 'https' : 'http';
    wp_enqueue_style( 'timetravel_opensans', "$protocol://fonts.googleapis.com/css?family=Open+Sans" );
}
...
//Custom menu header
function ab_tf_add_first_nav_item($items , $args) {
	if( $args->theme_location == 'primary-menu')  {
 	 return '<div class="nav-header dl-animate-in-2">MENU</div>'.$items;
	}else{
		return $items;
	}
}
...
//Adds search in menu
function ab_tf_add_search_box_to_menu( $items, $args ) {
   if( $args->theme_location == 'primary-menu')  {
        return "<li class='menu-header-search'><form action='".home_url()."' id='searchform' method='get'><input type='text' name='s' id='s' placeholder=''></form></li>". $items;
   }else{
		return $items;
	}
}
