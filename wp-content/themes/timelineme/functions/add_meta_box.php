...
$custom_meta_fields = array(
	...
	array(
		'label'	=> ' Position',
		'desc'	=> '',
		'id'	=> $prefix.'select_content_position',
	...
	array(
		'label'	=> ' Width (only for "square"-"centered" posts)',
		'desc'	=> '',
		'id'	=> $prefix.'select_content_width',
		'type'	=> 'select_dropdown',
		'options' => array (
			'one' => array (
				'label' => 'Boxed',
	...
	array(
		'label'	=> ' Bottom line if post info adta is hidden',
		'desc'	=> '',
	...
	array(
		'label'	=> ' Featured image in full post',
		'desc'	=> '',
	...
	array(
		'label'	=> ' Excerpt ( Selecting off will enabel html tags. Use it if you want to embed soemthing )',
		'desc'	=> '',
...
array(
	...
	array(
		'label'	=> ' Bottom line if page info is hidden',
		'desc'	=> '',
		'id'	=> $prefix.'select_show_soc',
		'type'	=> 'select_dropdown',
		'options' => array (
				...
				switch($field['type']) {
					case 'select_row_position':
						...
						foreach ( $field['options'] as $option ) {
							if( $meta == '' &&  $field['id'] == 'custom_select_row_style'){	
								...
								if(of_get_option('show-ds-comments') == "on"){ 						
									$meta = 'on';
								}else if(of_get_option('show-ds-comments') == "off" ){
									$meta = 'off';
								}else{
									$meta = 'off';
								}			
					...
					case 'select_dropdown':
						...
						foreach ($field['options'] as $option) {
						   ...
						   }else if( $meta == '' &&  $field['id'] == 'custom_select_content_position'){	
