					...
					<div class="icon-soc-container">
						...
						<?php
							if($ab_tf_post_showcategory != "hide"){		
								...
								<div class="empty-left time-holder "> <a class="read-more-init" href="<?php echo get_category_link( $category[0]->term_id );?>"><i class="icon-tag icon-large"></i> <?php echo $category[0]->cat_name;?></a></div>
								<div class="empty-left user-holder"><a href="#"><i class="icon-user icon-large"></i> <?php  the_author(); ?> </a></div><?php 
								if ( comments_open()){?>
							...
							if(!empty( $prevPost )){ ?>
								...
								<div class="empty-right time-holder prevpnav" data-ot='<div class="prevpnav-tip"><?php echo htmlentities($rmnext, ENT_QUOTES, "UTF-8");?><div class="tiptitle"><?php previous_post_link(' %link ');?></div><?php echo "<br>".$prev_post_excerpt;?></div>'  data-ot-fixed="flase"  data-ot-background="rgba(0,0,0,0.7)" data-ot-border-color="rgba(0,0,0,0.8)" data-ot-auto-offset="true" data-ot-stem-length="12" data-ot-offset="[ 0, -6 ]"  data-ot-tip-joint="bottom center" data-ot-target="true" data-ot-border-radius="0">
							...
							if($large_image_url_n[0]){
								$rmnext ="<img  class='tipimg'  src='".$large_image_url_n[0]."'/>";
                                    ...
                                    <div class="empty-right time-holder nextpnav <?php if(empty( $prevPost )){?> no-border<?php }?>" data-ot='<div class="prevpnav-tip"><?php echo htmlentities($rmnext, ENT_QUOTES, "UTF-8");?><div class="tiptitle"><?php next_post_link(' %link ');?></div><?php echo "<br>".$next_post_excerpt;?>&nbsp;</div>'  data-ot-fixed="flase"  data-ot-background="rgba(0,0,0,0.7)" data-ot-border-color="rgba(0,0,0,0.8)" data-ot-auto-offset="true" data-ot-stem-length="12" data-ot-offset="[ -10, -6 ]" data-ot-tip-joint="bottom center" data-ot-target="true" data-ot-border-radius="0">
					...
					<div class="ss-full ss-row fb-holder ss-stand-alone">
						<div class="container-border">
							<div class="gray-container <?php global $ab_tf_post_color; echo $ab_tf_post_color;?>">
								...
								<div class="nano">
									<div class="cscrol content">
                                    	<div class="fb-comments" data-href="<?php the_permalink(); ?>" data-num-posts="2" data-height="250" data-width="470"  data-colorscheme="dark" >
                                        </div>
									</div>
                                </div>
                                <div class="icon-soc-container">
